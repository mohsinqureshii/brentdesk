...
const TYPE_META: Record<string, { icon: LucideIcon; label: string; tone: string }> = {
  article: { icon: Newspaper, label: "Article", tone: "text-blue-600 dark:text-blue-400" },
  video: { icon: PlayCircle, label: "Video", tone: "text-red-600 dark:text-red-400" },
  photos: { icon: Images, label: "Photos", tone: "text-violet-600 dark:text-violet-400" },
  report: { icon: FileText, label: "Report", tone: "text-emerald-600 dark:text-emerald-400" },
  press_release: {
    icon: Megaphone,
    label: "Press release",
  ...
  other: { icon: Link2, label: "Link", tone: "text-muted-foreground" },
};
