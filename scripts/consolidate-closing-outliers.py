#!/usr/bin/env python3
"""Apply the 12 decisive closing rewrites while preserving locked metadata."""
...
RESULTS_SOURCE = Path("/home/ubuntu/rewrite_closing_review_outliers.json")
RESULTS_COPY = BASE / "qa" / "closing-outlier-results.json"
PACKETS = BASE / "qa" / "closing-correction-briefs"
DRAFTS = BASE / "drafts" / "raw"
LOG = BASE / "qa" / "closing-outlier-consolidation.json"
...
def apply(record: dict) -> dict:
    ...
    current["editorial_notes"] = corrected.get("editorial_notes") or "Closing source-bound newsroom rewrite applied; draft requires human review."
