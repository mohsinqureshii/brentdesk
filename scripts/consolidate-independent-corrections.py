#!/usr/bin/env python3
"""Apply 45 independently reviewed body corrections while preserving locked metadata."""
...
RESULTS_SOURCE = Path("/home/ubuntu/correct_independent_review_findings.json")
RESULTS_COPY = BASE / "qa" / "independent-correction-results.json"
PACKETS = BASE / "qa" / "independent-correction-briefs"
DRAFTS = BASE / "drafts" / "raw"
LOG = BASE / "qa" / "independent-correction-consolidation.json"
...
def apply(record: dict) -> dict:
    ...
    current["editorial_notes"] = corrected.get("editorial_notes") or "Independent editorial review corrections applied; draft requires final human review."
